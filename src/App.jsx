...
// --- Data ---
const skills = [
  "HTML", "CSS", "Python", "Numpy", "Pandas", "SQL"
];
    ...
    <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="order-2 md:order-1 text-center md:text-left space-y-6 z-10">
        ...
        <p className="text-lg text-zinc-400 leading-relaxed max-w-lg mx-auto md:mx-0">
          I'm a 3rd year Computer Engineering student who is still learning, passionate about AI/ML and trying to implement those theoretical knowledge to practical things. Trying to keep myself up to date with the news and trends of technology.
        </p>
        <p className="text-lg text-zinc-400 leading-relaxed max-w-lg mx-auto md:mx-0">
          Currently pursuing my B.Tech at <span className="text-zinc-200 font-medium">DY Patil's Ramrao Adik Institute of Technology, Navi Mumbai 📍</span>.
        </p>
        <div className="pt-4">
